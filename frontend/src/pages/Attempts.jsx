...
export function Attempts() {
  ...
  const handleCreateAttempt = (e) => {
    ...
    const selectedCandidate = candidates.find(c => c.id == newAttempt.candidateId);
                ...
                <div>
                  {filteredAttempts.length === 0 ? (
                    <div className="text-center py-8 text-gray-500 px-4">
                      No attempts found. {searchQuery ? "Try different search" : "Create new attempt"}
                    </div>
                  ) : (
                          ...
                          <div className="col-span-4 p-4">
                            ...
                            {attempt.score && (
                              <div className="text-neutral-500 text-xs mt-1">
                                Score: {attempt.score}% • Time: {attempt.timeSpent}
                              </div>
                            )}
                          </div>
            ...
            <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm border border-neutral-100 overflow-hidden">
              ...
              >
                  ...
                  >
                    ...
                    {tests.map(test => (
                      <option key={test.id} value={test.id}>
                        {test.name} ({test.questions} questions, {test.timeLimit} min)
                      </option>
                    ))}
                  </select>
                </div>
                ...
                <div className="flex items-center space-x-3 pt-4">
                  ...
                  />
                  <label htmlFor="autosend" className="text-neutral-700 text-sm font-medium">
