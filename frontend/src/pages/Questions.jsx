...
export function Questions() {
  ...
  const handleViewDetails = (question) => {
    alert(`Details for: ${question.text}\nType: ${question.type}\nDifficulty: ${question.difficulty}`);
  };
            ...
            <div>
              <div className="grid grid-cols-12 bg-gray-50 border-b border-zinc-200 text-xs">
                <div className="col-span-4 p-3">
                  <span className="text-neutral-700 font-bold font-['Inter']">Question</span>
                </div>
                
                <div className="col-span-2 p-3">
                  <span className="text-neutral-700 font-bold font-['Inter']">Type</span>
                </div>
                
                <div className="col-span-2 p-3 pr-1">
                  <span className="text-neutral-700 font-bold font-['Inter']">Difficulty</span>
                </div>
                
                <div className="col-span-1 p-3 pl-1">
                  <span className="text-neutral-700 font-bold font-['Inter']">Tags</span>
                </div>
                
                <div className="col-span-3 p-3">
                  <span className="text-neutral-700 font-bold font-['Inter']">Actions</span>
                </div>
              </div>
              
              <div>
                {loading ? (
                  <div className="text-center py-8 text-gray-500 text-sm">Loading questions...</div>
                ) : error ? (
                  <div className="text-center py-8 text-red-500 text-sm">{error}</div>
                ) : filteredQuestions.length === 0 ? (
                  <div className="text-center py-8 text-gray-500 text-sm">
                    No questions found. {searchQuery ? "Try different search" : "Add your first question"}
                  </div>
                ) : (
                      ...
                      <div className="col-span-3 p-3">
                        <div className="flex justify-center gap-1">
                          <button 
                            ...
                            className="px-1.5 py-1 bg-purple-800 rounded text-white text-xs font-medium hover:bg-purple-900 transition-colors whitespace-nowrap min-w-[50px]"
                          >
                            Detail
                          </button>
                          <button 
                            onClick={() => handleEditQuestion(question)}
                            className="px-1.5 py-1 bg-slate-500 rounded text-white text-xs font-medium hover:bg-slate-600 transition-colors whitespace-nowrap min-w-[45px]"
                          >
                            Edit
                          </button>
                          <button 
                            onClick={() => handleDeleteQuestion(question.id)}
                            className="px-1.5 py-1 bg-pink-800 rounded text-white text-xs font-medium hover:bg-pink-900 transition-colors whitespace-nowrap min-w-[50px]"
                          >
                            Delete
                          </button>
                        </div>
